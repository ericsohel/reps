...
export const CHUNKS: readonly Chunk[] = [
  ...
  },
  {
    ...
    label: "Primitives",
    tier: "core",
    moduleIds: ["arrays-hashing", "bit-manip"],
  },
  {
    id: "recursion-lists",
    label: "Recursion & Lists",
    tier: "core",
    moduleIds: ["backtracking", "linked-list"],
  },
  {
    id: "sort-stack",
    label: "Sorting & Stack",
    tier: "core",
    moduleIds: ["sorting", "stack"],
  },
  {
    id: "prefix-dsu",
    label: "Prefix Sums & Union-Find",
    tier: "core",
    moduleIds: ["prefix-sums", "union-find"],
  },
  {
    id: "two-pointers-greedy",
    label: "Two Pointers & Greedy",
    tier: "core",
    moduleIds: ["two-pointers", "greedy"],
  },
  {
    id: "window-mono-stack",
    label: "Window & Monotonic Stack",
    tier: "core",
    moduleIds: ["sliding-window", "monotonic-stack"],
  },
  {
    id: "binary-search-trees",
    label: "Binary Search & Trees",
    tier: "core",
    moduleIds: ["binary-search", "trees"],
  },
  {
    id: "bs-answer-heap",
    label: "BS Answer & Heap",
    tier: "core",
    moduleIds: ["bs-answer", "heap"],
  },
  {
    id: "tries-mono-deque",
    label: "Tries & Monotonic Deque",
    tier: "core",
    moduleIds: ["tries", "monotonic-deque"],
  },
  {
    id: "dp-intro-strings",
    label: "DP Intro & Strings",
    tier: "core",
    moduleIds: ["dp-intro", "strings"],
  },
  {
    id: "knapsack-lis",
    label: "Knapsack & LIS/LCS",
    tier: "core",
    moduleIds: ["knapsack", "lis-lcs"],
  },
  {
    id: "dp-2d-intervals",
    label: "2D DP & Intervals",
    tier: "core",
    moduleIds: ["dp-2d", "intervals"],
  },
  {
    id: "dp-trees-graph",
    label: "DP Trees & Graph Traversal",
    tier: "core",
    moduleIds: ["dp-trees", "graph-traversal"],
  },
  {
    id: "topo-design",
    label: "Topo Sort & Design",
    tier: "core",
    moduleIds: ["topo-sort", "design"],
  },
  {
    id: "shortest-paths",
    label: "Shortest Paths",
    tier: "core",
    moduleIds: ["shortest-paths"],
  },
  // ── FAANG+ tier ──────────────────────────────────────────────────────────
  {
    id: "mst-coord-comp",
    label: "MST & Coord Compression",
    tier: "faang-plus",
    moduleIds: ["mst", "coord-comp"],
  },
  {
    id: "adv-graphs-sparse",
    label: "Advanced Graphs & Sparse Table",
    tier: "faang-plus",
    moduleIds: ["adv-graphs", "sparse-table"],
  },
  {
    id: "fenwick-bitmask",
    label: "Fenwick & Bitmask DP",
    tier: "faang-plus",
    moduleIds: ["fenwick", "bitmask-dp"],
  },
  {
    id: "seg-interval",
    label: "Segment Tree & Interval DP",
    tier: "faang-plus",
    moduleIds: ["seg-tree", "interval-dp"],
  },
  {
    id: "geometry",
    label: "Geometry",
