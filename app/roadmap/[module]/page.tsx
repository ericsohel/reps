...
const MODULE_META = {
  ...
  "sorting":         { file: "03-sorting.md",             num: 3,  title: "Sorting" },
  "prefix-sums":     { file: "04-prefix-sums.md",         num: 4,  title: "Prefix Sums" },
  "two-pointers":    { file: "05-two-pointers.md",        num: 5,  title: "Two Pointers" },
  "sliding-window":  { file: "06-sliding-window.md",      num: 6,  title: "Sliding Window" },
  "stack":           { file: "07-stack.md",               num: 7,  title: "Stack" },
  "monotonic-stack": { file: "08-monotonic-stack.md",     num: 8,  title: "Monotonic Stack" },
  "monotonic-deque": { file: "09-monotonic-deque.md",     num: 9,  title: "Monotonic Deque" },
  "linked-list":     { file: "10-linked-list.md",         num: 10, title: "Linked List" },
  "binary-search":   { file: "11-binary-search.md",       num: 11, title: "Binary Search" },
  "bs-answer":       { file: "12-binary-search-answer.md",num: 12, title: "Binary Search on Answer" },
  "backtracking":    { file: "13-backtracking.md",        num: 13, title: "Recursion & Backtracking" },
  "trees":           { file: "14-trees.md",               num: 14, title: "Trees" },
  "tries":           { file: "15-tries.md",               num: 15, title: "Tries" },
  "heap":            { file: "16-heap.md",                num: 16, title: "Heap / Priority Queue" },
  "greedy":          { file: "17-greedy.md",              num: 17, title: "Greedy" },
  "intervals":       { file: "18-intervals.md",           num: 18, title: "Intervals & Sweep Line" },
  "graph-traversal": { file: "19-graph-traversal.md",     num: 19, title: "Graph Traversal" },
  "topo-sort":       { file: "20-topological-sort.md",    num: 20, title: "Topological Sort" },
  "union-find":      { file: "21-union-find.md",          num: 21, title: "Union-Find / DSU" },
  "shortest-paths":  { file: "22-shortest-paths.md",      num: 22, title: "Shortest Paths" },
  "mst":             { file: "23-mst.md",                 num: 23, title: "Minimum Spanning Tree" },
  "adv-graphs":      { file: "24-advanced-graphs.md",     num: 24, title: "Advanced Graphs" },
  "dp-intro":        { file: "25-dp-intro.md",            num: 25, title: "DP Intro / 1D" },
  "dp-2d":           { file: "26-dp-2d.md",               num: 26, title: "2D / Grid DP" },
} as const;
