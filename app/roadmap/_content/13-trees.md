...
| 9 | [Tree Diameter](https://cses.fi/problemset/task/1131) | CSES | Normal | UG ⭐ | extension | Unrooted general tree — two-pass BFS algorithm; first farthest is one endpoint, second farthest from it is the other |
