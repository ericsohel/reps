...
**Patterns introduced:** none new (specialises monotonic invariant for same-direction pointers)  
**Patterns reused:** complement lookup (over window dicts), monotonic invariant
...
|---|---------|--------|-----------|------|------|-----------------|
| 1 | [Subarray Sums I](https://cses.fi/problemset/task/1660) | CSES | Very Easy | UG | baseline | Variable window on positive integers, exact match — this was your Step 1 problem |
...
| 6 | [Diamond Collector](http://www.usaco.org/index.php?page=viewproblem2&cpid=643) | USACO Silver | Normal | UG ⭐ | extension | Sort + variable window with `max − min ≤ K` constraint — must recognise the pattern from the problem statement |
